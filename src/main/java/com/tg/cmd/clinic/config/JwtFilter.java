package com.tg.cmd.clinic.config;
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        //  String authServiceUrl="http://localhost:8081/api/auth/validate";
        ...
        try {
            ...
            System.out.println("11111111111111111111111" + requestEntity);
            System.out.println("11111111111111111111111" + headers);
 
            // Send validation request to Authentication service
            System.out.println("------------------------------ Clinic" + requestEntity); 
